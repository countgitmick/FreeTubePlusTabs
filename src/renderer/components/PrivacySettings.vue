  ...
  >
    ...
    <div class="switchColumnGrid">
      ...
      <div class="switchColumn">
        <FtToggleSwitch
          ...
          :disabled="!rememberSearchHistory || lifetimeOption === 'forever'"
    ...
    <FtFlexBox>
      <FtSelect
        ...
        :disabled="!rememberHistory && !rememberSearchHistory"
      ...
      <FtInput
        ...
        :disabled="!rememberHistory && !rememberSearchHistory || lifetimeOption === 'forever'"
